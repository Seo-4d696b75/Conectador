...
public class VideoInfoManager extends VideoInfo {
    ...
    public VideoInfoManager(int index){
        super(index);
    }
    public VideoInfoManager(){}

    //url from which details of video you can get
    private String url = "http://ext.nicovideo.jp/api/getthumbinfo/";
    ...
    public boolean complete(){
        ...
        try {
            ...
            if ( thumbnailUrl == null){
                ...
                thumbnailUrl = new String[]{target};
            }
            if ( date == null){
            ...
            if ( tags == null ){
                ...
                String[] tags = getTags(target,VideoInfo.TAG);
    ...
    private String[] getTags(String res, int key){
        if ( patternMap.containsKey(key) ){
            Matcher matcher = patternMap.get(key).matcher(res);
    ...
    public VideoInfo upCast(){
        VideoInfo info = new VideoInfo(index);
    ...
    public void analyze(VideoInfoManager target,String[] keyWords){
        ...
        float tagsP = compareTags(target.getTags(),tags);
